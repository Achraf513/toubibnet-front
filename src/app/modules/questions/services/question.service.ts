...
export class QuestionService {
  ...
  public getAll(page:number,size:number): Observable<Question[]> {
    return this.httpClient.get<Question[]>(this.questionUrl+'/page/'+page+'/'+size);
  }
  ...
  public getByWord(mot: string,page:number,size:number): Observable<Question[]> {
    return this.httpClient.get<Question[]>(this.questionUrl + '/search/'+mot+'/page/'+size+'/'+page);
  }
  ...
  public getByCategorie(category: string | undefined,page:number,size:number): Observable<Question[]> {
    return this.httpClient.get<Question[]>(this.questionUrl + '/category/'+category+'/page/'+page+'/'+size );
  }
